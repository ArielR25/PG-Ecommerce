...
export function getGenders() {
  return async function (dispatch) {
    var genders = await fetch(
      "https://pg-henry-ecommerce.herokuapp.com/generos"
    );
...
export function createBook(payload, token) {
  return async function (dispatch) {
    var book = await fetch(
      "https://pg-henry-ecommerce.herokuapp.com/productos",
      {
        method: "POST",
        headers: {
          "x-token": token,
...
export function addCart(id) {
  return async function (dispatch) {
    var book = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/cart/${id}`
    );
...
export function getOrdenes(token) {
  return async function (dispatch) {
    let ordenes = await fetch(
      "https://pg-henry-ecommerce.herokuapp.com/orden",
      {
        method: "GET",
        headers: {
          "x-token": token,
...
export function getOrdenesID(id) {
  return async function (dispatch) {
    let orden = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/orden/${id}`
    );
...
export function getOrdenesUser(token) {
  return async function (dispatch) {
    let ordenesUser = await fetch(
      "https://pg-henry-ecommerce.herokuapp.com/auth/historyShopping",
      {
        method: "GET",
        headers: {
          "x-token": token,
...
export function updateOrden(state, id, token) {
  return async function (dispatch) {
    var updateState = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/orden/${state}/${id}`,
      {
        method: "post",
        headers: {
          "x-token": token,
...
export function getProfile(id) {
  return async function (dispatch) {
    var profile = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/auth/profile/${id}`
    );
...
export function profileUpdate(id, payload) {
  return async function (dispatch) {
    var profileUptate = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/auth/profile/edit/${id}`,
      {
        method: "POST",
        headers: {
          Accept: "application/json",
...
export function getProfiles() {
  return async function (dispatch) {
    var profiles = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/auth/profiles`
    );
...
export function getWhishlist(token) {
  return async function (dispatch) {
    let whishlist = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/auth/whishlist`,
      {
        method: "GET",
        headers: {
          "x-token": token,
...
export function postWhishlist(idProducto, token) {
  return async function (dispatch) {
    let whishlist = await fetch(
      `https://pg-henry-ecommerce.herokuapp.com/auth/whishlist/${idProducto}`,
      {
        method: "POST",
        headers: {
          "x-token": token,
