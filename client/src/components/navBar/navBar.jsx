...
export default function NavBar() {
  ...
  const handleChangePrecio = () => {
    ...
    let button_filtrar_precio = document.getElementById(
      "button_filtrar_precio"
    );

    if (
      (campoMin && campoMax && campoMin >= campoMax) ||
      !campoMin ||
      !campoMax
    ) {
    ...
    <div className="nav_principal">
      <div>
        <div className="mainNavBar">
          {url === "http://localhost:3000/" ? (
            <div>
              <button
                className={
                  leftBarState
                    ? "leftNavBarButton_active"
                    : "leftNavBarButton_inactive"
                }
                onClick={leftBarFunction}
              >
                ...
                <div className="botonesPaginadoOrdenado">
                  <div className="contenedor_filtrado">
                    ...
                    <div className="filtrado_precio">
                      ...
                      <button
                        id="button_filtrar_precio"
                        className="button_filtrar_precio_inactivo"
          ...
          {user && !user.admin && (
            <button className="favoritos_button_home">
              <NavLink
                to="/whishlist"
          ...
          <button className="sucursales_button_home">
            <NavLink
              to="/sucursales"
              style={{ textDecoration: "none", color: "white" }}
            >
          ...
          <div className="icono_Usuario">
            <div
              id={
                loginBarState
                  ? "loginNavBarbutton_active"
                  : "loginNavBarbutton_inactive"
              }
              className="loginNavBarbutton"
              onClick={loginBarFunction}
            >
              {user && user.uid ? (
                <img
            ...
            <div id="loginNavBar">
              <div id="buttonsForms">
                {!user ? (
                  <div>
                    <button onClick={openModal} className="userLoginButton">
                      Acceder
                    </button>
                    <button
                  ...
                  <div>
                    ...
                    <button
                      onClick={locaLogout}
                      className="userLoginButtonSesion"
                    >
                      {" "}
                      Cerrar Sesión{" "}
                    </button>
        ...
        {user && user.admin ? (
          ...
          <div>
            <div
              id={
                rightBarState
                  ? "rightNavBarButton_active"
                  : "rightNavBarButton_inactive"
              }
              className="rightNavBarButton"
              onClick={rightBarFunction}
            >
              <MdShoppingCart className="icono_nav_der" />{" "}
              <span className="numero_icono">
